...
#: Exchange на журнале пользователя просил 80 секунд, а мы сдавались уже на
#: 60 — и КАЖДАЯ часть окна календаря падала с «Max timeout reached», то
#: есть календарь не грузился вовсе. Ждать несколько минут не страшно:
#: синхронизация идёт в фоне и окно программы не блокирует.
_MAX_THROTTLE_WAIT = 300
