...
%changelog
* Fri Sep 19 2026 redmail <redmail@example.com> - 0.0.1-139
- Чужие календари, открытые вам, подключаются сами: при синхронизации (не чаще раза в шесть часов) программа обходит пользователей сервера, а если сервер их не перечисляет — адреса из адресной книги, и добавляет доступные календари с именем владельца в названии
