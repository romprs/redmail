...
- Готовый сценарий доставки (установка на ВМ, копии в `E:rr\dist` и `D:I` со сверкой
  сумм, отправка на .80, установка и перезапуск клиента) — в скретчпаде сессии `deliver.sh <N>`.
